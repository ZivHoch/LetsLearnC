...
function openOrCloseNav(flag) {
	if (flag) //the button pressed or not
	{
		count++;
...
function openOrCloseSideBar(flag) { //1 open 0 close
	document.getElementById("mySidenav").style.width = (flag) ? ("250px") : ("0");
	document.getElementById("topPage").style.marginRight = (flag) ? ("250px") : ("0");
}

function moveMain(flag) { //1 open 0 close
	document.getElementById("main").style.marginRight = (flag) ? ("250px") : ("0");
}

function moveSideBarButton(flag) { //1 open 0 close
	document.getElementById("topPageIcon").style.marginRight = (flag) ? ("250px") : ("-5px");
}
